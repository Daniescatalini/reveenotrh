...
export type Category = {
  ...
  icon: string;
  color: string;
  type: "conta" | "entrada" | "meta" | "variavel";
  description?: string;
  active: boolean;
};
...
export const initialCategories: Category[] = [
  ...
  { id: 3, name: "Água", icon: "Droplets", color: "#4f8fd8", type: "conta", active: true },
  { id: 4, name: "Internet", icon: "Wifi", color: "#8a6dd8", type: "conta", active: true },
  { id: 5, name: "Dívidas", icon: "CreditCard", color: "#d94836", type: "conta", active: true },
  { id: 6, name: "Alimentação", icon: "Utensils", color: "#2f9f73", type: "conta", active: true },
  { id: 7, name: "Carro", icon: "Car", color: "#2563eb", type: "conta", active: true },
  { id: 8, name: "Saúde", icon: "Cross", color: "#16a34a", type: "conta", active: true },
  { id: 9, name: "Estudos", icon: "BookOpen", color: "#7c3aed", type: "conta", active: true },
  { id: 10, name: "Esporte", icon: "SoccerBall", color: "#0f766e", type: "conta", active: true },
  { id: 11, name: "Imposto", icon: "BadgeDollarSign", color: "#64748b", type: "conta", active: true },
  ...
  { id: 19, name: "Celular", icon: "Smartphone", color: "#475569", type: "conta", active: true },
  { id: 20, name: "Alerta", icon: "CircleAlert", color: "#dc2626", type: "conta", active: true },
  { id: 21, name: "Pessoal", icon: "Sparkles", color: "#c56a37", type: "conta", active: true },
  { id: 22, name: "Salário mensal", icon: "Wallet", color: "#2f9f73", type: "entrada", active: true },
  { id: 23, name: "Renda extra", icon: "Briefcase", color: "#d75c27", type: "entrada", active: true },
  { id: 24, name: "Bônus", icon: "Gift", color: "#4f8fd8", type: "entrada", active: true },
  { id: 25, name: "Reserva", icon: "PiggyBank", color: "#d75c27", type: "meta", active: true },
  ...
  { id: 33, name: "Saúde", icon: "Cross", color: "#16a34a", type: "variavel", active: true },
  ...
  { id: 37, name: "Pedágio", icon: "Landmark", color: "#475569", type: "variavel", active: true },
  ...
  { id: 41, name: "Estacionamento", icon: "ParkingCircle", color: "#334155", type: "variavel", active: true },
];
